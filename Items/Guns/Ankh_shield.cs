...
namespace RPGworldMod
{
    ...
    public class Ankh_shield : GunBehaviour
    {
        public static int ID;
        public static Gun gun_fr;
        public static void Add()
        {
            Gun gun = ETGMod.Databases.Items.NewGun("Ankh Shield", "ankh_shield");
            Game.Items.Rename("outdated_gun_mods:ankh_shield", "rpgworld:ankh_shield");
            gun.gameObject.AddComponent<Ankh_shield>();
            ...
            gun.DefaultModule.ammoType = GameUIAmmoType.AmmoType.CUSTOM;
            gun.DefaultModule.customAmmoType = CustomClipAmmoTypeToolbox.AddCustomAmmoType("Ankh Durability",
                "RPGworldMod/Resources/CustomGunAmmoTypes/ankh_durability_clipfull",
            ...
            Ankh_shield.ID = gun.PickupObjectId;
        ...
        public static PlayerController Wielder = null;
        ...
        public override void OwnedUpdate(GameActor owner, GunInventory inventory)
        {
            ...
            if (Wielder != null && !gun.IsFiring && startedFiring)
            {
                ...
                PassiveItem.DecrementFlag(Wielder, typeof(Ankh_shield));
            }
        ...
        public override void Update()
        {
            ...
            if (gun.IsFiring)
            {
                if (!startedFiring)
                {
                    ...
                    if (playerController != null)
                    {
                        ...
                        PassiveItem.IncrementFlag(playerController, typeof(Ankh_shield));
                    }
                }
            }
            else if (startedFiring)
            {
                ...
                if (playerController != null)
                {
                    ...
                    PassiveItem.DecrementFlag(playerController, typeof(Ankh_shield));
                }
                //AkSoundEngine.PostEvent("Play_ITM_Crisis_Stone_Shield_01", gun.gameObject);
            }
