                ...
                if (flag)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        if (flag3)
                        {
                            ...
                            if (flag4)
                            {
                                //This would not work in coop and i have no idea how to code it properly
                                if (sourceProjectile.PossibleSourceGun.PickupObjectId == Ankh_shield.ID)
                                {
                                    if (!owner.PlayerHasActiveSynergy("RPGW Autumn Mirage"))
                                    {
                                        if (!projectile.HasDiedInAir) Ankh_shield.Damage++;
                                        if ((Ankh_shield.gun_fr.ClipCapacity - Ankh_shield.Damage) <= 1 && !Ankh_shield.playEmptyAnim)
                                        {
                                            Ankh_shield.Damage = Ankh_shield.gun_fr.ClipCapacity;
                                            Ankh_shield.DoMacroBlank(owner.specRigidbody.UnitCenter);
                                            Ankh_shield.playEmptyAnim = true;
                                        }
                                    }
                                }
                                if (sourceProjectile.PossibleSourceGun.PickupObjectId == Alt_ankh_shield.ID)
                                {
                                    if (!owner.PlayerHasActiveSynergy("RPGW Autumn Mirage"))
                                    {
                                        if (!projectile.HasDiedInAir) Alt_ankh_shield.Damage++;
                                        if ((Alt_ankh_shield.gun_fr.ClipCapacity - Alt_ankh_shield.Damage) <= 1 && !Alt_ankh_shield.playEmptyAnim)
                                        {
                                            Alt_ankh_shield.Damage = Alt_ankh_shield.gun_fr.ClipCapacity;
                                            Alt_ankh_shield.DoMacroBlank(owner.specRigidbody.UnitCenter);
                                            Alt_ankh_shield.playEmptyAnim = true;
                                        }
                                    }
                                }
