...
namespace RPGworldMod
{
    class InitialiseSynergies
    {
        public static void DoInitialisation()
        {
            ...
            ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW King Of The First Chamber", "Король первого зала");
            ...
            ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW King Of The Second Chamber", "Король второго зала");
            ...
            ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW King Of The Third Chamber", "Король третьего зала");
            ...
            ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW King Of The Fourth Chamber", "Король четвёртого зала");
            ...
            ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW King Of The Fifth Chamber", "Король пятого зала");
            ...
            ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW Green Scarf", "Зелёный шарф");
            ...
            ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW Destructive Ankh Candy", "Разрушительный леденец Анх");
            ...
            //ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW Autumn Mirage", "Осенний мираж");
            try
            {
            ...
            ETGMod.Databases.Strings.Synergy.Set(StringTableManager.GungeonSupportedLanguages.RUSSIAN, "RPGW Bounce Sign", "Знак отскока");
        }
